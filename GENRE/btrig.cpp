...
CMachineParameter const paraRandVolume =
{
            pt_byte,                        // Parameter data type
            "Random Volume",            // Parameter name as its shown in the parameter 
                                                // window
            "Random Volume efx amount",            // Parameter description as its shown in the 
                                                // pattern view's statusbar
            0,                                    // Minimum value
            0xFE,                        // Maximum value
            0xFF,                        // Novalue, this value means "nothing 
...
CMachineParameter const paraRandPitch =
{
            pt_byte,            // Parameter data type
            "Random Pitch",            // Parameter name as its shown in the parameter 
                                    // window
            "Random Pitch efx amount",            // Parameter description as its shown in the pattern 
                                    // view's statusbar
            0,                        // Minimum value
            0xFE,                        // Maximum value
...
CMachineParameter const paraRandRtgLen =
{
            pt_byte,                        // Parameter data type
            "Random Rtg Len",            // Parameter name as its shown in the parameter 
                                                // window
            "Random Retrigger Length efx amount",            // Parameter description as its shown in the 
                                                // pattern view's statusbar
            0,                                    // Minimum value
            0xFE,                        // Maximum value
            0xFF,                        // Novalue, this value means "nothing 
...
CMachineParameter const paraRandPan =
{
            pt_byte,            // Parameter data type
            "Random Pan",            // Parameter name as its shown in the parameter 
                                    // window
            "Random Pan efx amount",            // Parameter description as its shown in the pattern 
                                    // view's statusbar
            0,                        // Minimum value
            0xFE,                        // Maximum value
            0xFF,                        // Novalue, this value means "nothing happened" in 
...
void mi::Tick() {
	...
	*/		
			if (gval.randpan != paraRandPan.NoValue){
				//EffCom[9].IntValue = gval.randvolume;
				mi::SetNewEffCom(8, gval.randpan);
				//AtkLen = (int)(Attack * (RetrigLen - EffCom[3].IntValue));
				
			}
			if (gval.randvolume != paraRandVolume.NoValue){
				//EffCom[9].IntValue = gval.randvolume;
				mi::SetNewEffCom(9, gval.randvolume);
				//AtkLen = (int)(Attack * (RetrigLen - EffCom[3].IntValue));
				
			}
			if (gval.randpitch != paraRandPitch.NoValue){
				//EffCom[9].IntValue = gval.randvolume;
				mi::SetNewEffCom(12, gval.randpitch);
				//AtkLen = (int)(Attack * (RetrigLen - EffCom[3].IntValue));
				
			}
			if (gval.randrtglen != paraRandRtgLen.NoValue){
				//EffCom[9].IntValue = gval.randvolume;
				mi::SetNewEffCom(14, gval.randrtglen);
				//AtkLen = (int)(Attack * (RetrigLen - EffCom[3].IntValue));
